 ...
 */
public abstract class BaseMazeGame extends Game {
    /**
     * Stores reference to game; used when calling setActiveScreen method.
     */
    private static BaseMazeGame game;
    ...
    public void create() {
        ...
        FreeTypeFontGenerator fontGenerator = new FreeTypeFontGenerator(Gdx.files.internal("maze/OpenSans.ttf"));
